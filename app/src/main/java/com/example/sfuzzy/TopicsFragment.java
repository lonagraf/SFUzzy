...
public class TopicsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnProfile.setOnClickListener(v -> requireActivity().getSupportFragmentManager()
                .beginTransaction()
        ...
        Button btnOpen1 = view.findViewById(R.id.btnOpen);
        ...
        Button btnOpen2 = view.findViewById(R.id.btnOpen2);
        ...
        Button btnOpen3 = view.findViewById(R.id.btnOpen3);
        ...
        Button btnOpen4 = view.findViewById(R.id.btnOpen4);
